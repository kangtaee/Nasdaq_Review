...
## 1. 개요
![nasdaqlogo](img/1_5NxI2F_IiRlviY90lecGWg.jpg)
### 1-1 문제 정의
...
정보는 시장 가격에 반영된다는 이론이 있지만, 수치로 표현되지 않는 뉴스의 감정적인 뉘앙스까지 반영하기는 어렵다.  

그래서 최근에는 자연어처리(NLP) 기술을 이용해 뉴스의 감성을 분석하려는 시도들이 늘어나고 있고, 감성 분석 결과를 바탕으로 **실제 주가 반응까지 예측해보려는 연구와 프로젝트**도 활발하게 진행되고 있다.

특히 NASDAQ처럼 기술주 중심의 시장은 뉴스에 민감하게 반응하는 종목이 많기 때문에, 감성 분석을 통해 단기 주가 흐름을 예측해볼 수 있는 좋은 실험 대상이라고 생각했다.
