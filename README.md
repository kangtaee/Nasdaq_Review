...
정보가 시장 가격에 빠르게 반영된다는 이론(Efficient Market Hypothesis)은 널리 알려져 있지만, 뉴스에 담긴 **감정적 뉘앙스**나 어조까지 반영하기에는 기존 수치 기반 분석만으로는 한계가 있다.  [관련논문](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=5086825) 
